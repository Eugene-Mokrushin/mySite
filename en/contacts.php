    ...
    <div class="container">
        ...
        <main>
            <div class="email-box">
                ...
                <div class="simple">let's make it simple</div>
                <div class="tg">
                    (Telegram is also an option - <a href="https://t.me/ZheRoNA" target="_blank">@ZheRoNA</a>)
                </div>
            </div>
            <div class="can-find">
                <div class="title-map">
                    <div class="find-text">Also you can find me here for now</div><img src="../photos/icos/1654366_arrow_clockwise_swirl_tornado_twister_icon.svg" alt="arrow">
                </div>
