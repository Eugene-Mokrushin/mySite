        ...
        <main>
            <div class="title-wrapper">
                <div class="title">
                    ...
                    <span id="name_tag">BLOG TIME!</span>
                </div>
                <div class="content">
                    <div class="content__container">
                        ...
                        <ul class="content__container__list">
                            <li class="content__container__list__item">coding !</li>
                            <li class="content__container__list__item">travelling !</li>
                            <li class="content__container__list__item">chill !</li>
