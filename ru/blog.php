...
<head>
    ...
    <link rel="stylesheet" href="../styles-additional/blog-ru.css">
    ...
    <div class="container">
        ...
        <main>
            <div class="title-wrapper">
                <div class="title">
                    <span id="time">Какой сечас час?</span>
                    <span id="name_tag">ВРЕМЯ БЛОГА!</span>
                </div>
                <div class="content">
                    <div class="content__container">
                        ...
                        <ul class="content__container__list">
                            <li class="content__container__list__item">коддинге !</li>
                            <li class="content__container__list__item">путешествиях !</li>
                            <li class="content__container__list__item">отдыхе !</li>
                            <li class="content__container__list__item">-бо всем !</li>
                        </ul>
                    </div>
                </div>
            </div>
