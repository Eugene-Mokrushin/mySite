...
<head>
    ...
    <link rel="stylesheet" href="../styles-additional/index-ru.css">
...
<body>
        ...
        <main>
            <div class="about-me">
                ...
                <div class="text-descrption">
                    <div class="title">Привет! Я&nbsp;-&nbsp;<span id="name_tag">Евгений.</span></div>
                    <div class="main-text" id="change-text">Зачем регистрироваться? Чтобы оставлять комментарии к моим постам! (В ближайшем будущем будут добавлены новые функции: создание генеалогического дерева или полезные API. Только для зарегистрированных пользователей!)
                    </div>
            ...
            <div class="blog">
                <div class="blog-title-main-wrapper">
                    <div class="blog-title-main">
                        ...
                        <div class="recent-posts">Недавние посты.</div>
                    </div>
                </div>
                            ...
                            <div class="blog-content">
                                <article class="text-part">
                                    ...
                                    <div class="read-more-wrapper">
                                        <div class="read-more" id="second-article"><a href="view.php?id=<?php echo $q_l_t['id']; ?>">Читать далее</a></div>
                                    </div>
                                </article>
                            </div>
            ...
            <div class="gallery-wrapper">
                <div class="title-galery"><span class="title">Галерея.</span></div>
                <div class="swiper">
    ...
    <script>
        if (window.screen.width >= 1024) {
            var text = ["Этот сайт не без багов! Пожалуйста, дайте знать, если найдете какие-либо! ", "Как вы наткнулись на этот сайт? Вы рекрутер, друг или сталкер? &#129320; \nНадеюсь, не все вместе...", "Зачем регистрироваться? Чтобы оставлять комментарии к моим постам! (В ближайшем будущем будут добавлены новые функции: создание генеалогического дерева или полезные API. Только для зарегистрированных пользователей!)"];
            var counter = 0;
