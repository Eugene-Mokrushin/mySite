...
if (isset($_REQUEST['login_btn'])) {
    ...
    if (empty($email)) {
        $errorMsgLogIn[0][] = 'Must enter email';
    } else if (empty($password)) {
        $errorMsgLogIn[1][] = 'Must enter password';
    } else {
        try {
            ...
            if ($select_stmt->rowCount() > 0) {
                if (password_verify($password, $row["password"])) {
                    ...
                    $errorMsgLogIn[3][] = 'Неправильный email или пароль';
                }
            } else {
                $errorMsgLogIn[3][] = 'Неправильный email или пароль';
            }
                    ...
                    <div class="form">
                        ...
                        <div class="form-element">
                            <div class="remember-me-wrapper">
                                <label for="remember-me" id="override-remember">Запомнить меня
