...
<head>
    ...
    <link rel="stylesheet" href="../styles-additional/styles-wip-ru.css">
            ...
            <div class="current-prodject-wrapper">
                ...
                <?php foreach ($query_wip_projects_first as $q_w_p_f) { ?>
                    ...
                    <div class="text-part" id="old-project-text">
                        <div class="title"><?php echo $q_w_p_f['title_ru'] ?></div>
                        <div class="main-descriptions"><?php echo $q_w_p_f['description_ru'] ?></div>
                    </div>
                <?php } ?>
            </div>
            ...
            <div class="past-projects-wrapper">
                <?php foreach ($query_wip_projects as $q_w_projects) { ?>
                    <div class="past-project">
                        ...
                        <div class="text-wrapper">
                            <div class="title-past-project"><?php echo $q_w_projects['title_ru'] ?></div>
                            <div class="small-description"><?php echo $q_w_projects['description_ru'] ?></div>
                        </div>
                    </div>
                <?php } ?>
                <div class="past-project">
                    ...
                    <img src="../photos/wip-covers/1_wip.png" alt="past-projec-cover" style="margin-left: 15px !important;">
                    <div class="text-wrapper">
                        <div class="title-past-project">Разработка личного сайта
                        </div>
                        <div class="small-description">Для того, чтобы незнакомые с git люди были в теме моих проектов, я хотел создать собственный сайт. Это также поможет делать специальные фичи для моих знакомых.</div>
                    </div>
                </div>
            </div>
        </main>
