            ...
            <div class="email-box">
                <div class="email-click">
                    ...
                    <div class="fixer" id="fixer">
                        <div class="bubble">Kopiert!</div>
                        <div class="pointer"></div>
                    </div>

                </div>
                <div class="simple">machen wir es einfach</div>
                <div class="tg">
                    (Telegramm ist auch eine Option - <a href="https://t.me/ZheRoNA" target="_blank">@ZheRoNA</a>)
                </div>
            </div>
            <div class="can-find">
                <div class="title-map">
                    <div class="find-text">Auch mich findest du vorerst hier</div><img src="../photos/icos/1654366_arrow_clockwise_swirl_tornado_twister_icon.svg" alt="arrow">
                </div>
