...
<head>
    ...
    <link rel="stylesheet" href="../styles-additional/styles-de.css">
...
<body>
        ...
        <main>
            <div class="about-me">
                ...
                <div class="text-descrption">
                    <div class="title">Hi! Ich bin<span id="name_tag"> Eugen.</span></div>
                    <div class="main-text" id="change-text">Warum sollte ich mich anmelden? Um Kommentare zu meinen Beiträgen zu hinterlassen! (In naher Zukunft werden neue Funktionen hinzugefügt, wie das Generieren von Stammbäumen oder nützliche APIs. Nur für registrierte Benutzer!)
                    </div>
            ...
            <div class="blog">
                <div class="blog-title-main-wrapper">
                    <div class="blog-title-main">
                        <div class="blog-title">Bloggen.</div>
                        <div class="recent-posts">Kürzliche Posts.</div>
                    </div>
                </div>
                            ...
                            <div class="blog-content">
                                <article class="text-part">
                                    ...
                                    <div class="read-more-wrapper">
                                        <div class="read-more" id="second-article"><a href="view.php?id=<?php echo $q_l_t['id']; ?>">Weiterlesen</a></div>
                                    </div>
                                </article>
                            </div>
            ...
            <div class="gallery-wrapper">
                <div class="title-galery"><span class="title">Galerie.</span></div>
                <div class="swiper">
    ...
    <script>
        if (window.screen.width >= 1024) {
            var text = ["Diese Seite ist nicht ohne Fehler! Bitte lass es mich wissen, wenn du welche findest... ", "Wie sind Sie auf diese Website gestoßen? Sind Sie Anwerber, Freund oder Stalker? &#129320; \nHoffe nicht auf einmal...", "Warum sollte ich mich anmelden? Um Kommentare zu meinen Beiträgen zu hinterlassen! (In naher Zukunft werden neue Funktionen hinzugefügt, wie das Generieren von Stammbäumen oder nützliche APIs. Nur für registrierte Benutzer!)"];
            var counter = 0;
